                                    ...
                                    <? foreach ($recomendacoesAmigos as $prodAmigos) { ?>
                                        <div class="ca-item ca-item-1 ">
                                    		<div class="ca-item-main produto">
                                                <div class="image"><a href="<? echo SYSURL ?>produto/detalhes.php?id=<? echo $prodAmigos->getId(); ?>"><img src="<? echo SYSURL; ?>images/nbs/<?php echo $prodAmigos->getImagem();?>" height="148" alt="Coffee Cups"></a></div>
                    ...
                    <div class="conjunto">
                        ...
                        <div id="ca-container-<? echo $perfil->getId(); ?>" class="ca-container" >
                            <div class="ca-wrapper">
                                ...
                                <div class="ca-item ca-item-1 ">
                                    <div class="ca-item-main produto">
                                        <div class="image"><a href="<? echo SYSURL ?>produto/detalhes.php?id=<? echo $prod->getId(); ?>"><img src="<? echo SYSURL; ?>images/nbs/<?php echo $prod->getImagem();?>" height="150" alt="Coffee Cups"></a></div>
